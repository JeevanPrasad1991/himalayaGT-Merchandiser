...
public class CommonString1 {
    ...
    public static final String FILE_PATH = Environment.getExternalStorageDirectory() + "/HimalayaGT_Images/";
    ...
    public static final String TABLE_INSERT_SKU_QWANTITY_DATA = "SKU_QWANTITY_DATA";
    ...
    public static final String CREATE_TABLE_INSERT_SKU_QWANTITY_DATA = "CREATE TABLE IF NOT EXISTS "
            + TABLE_INSERT_SKU_QWANTITY_DATA
            + "("
            + "KEY_ID"
            + " INTEGER PRIMARY KEY AUTOINCREMENT ,"
            + "BRAND_CD"
    ...
    public static final String CREATE_TABLE_STOCK_DATA = "CREATE TABLE IF NOT EXISTS STOCK_DATA " +
            "(Common_Id INTEGER, SKU_CD VARCHAR,SKU VARCHAR,BRAND_CD INTEGER," +
            " BRAND VARCHAR,CATEGORY_CD INTEGER, STORE_CD INTEGER,STATE_CD INTEGER,STORE_TYPE_CD VARCHAR,OPENING_TOTAL_STOCK INTEGER," +
            " FACING INTEGER,STOCK_UNDER_DAYS INTEGER,STOCK_UNDER_12 INTEGER," +
            " STOCK_GREATER_13 INTEGER,CATEGORY_IMAGE VARCHAR)";

    public static final String TABLE_STOCK_CATEGORY_DATA = "STOCK_CATEGORY_DATA";
    public static final String CREATE_TABLE_STOCK_CATEGORY_DATA = "CREATE TABLE IF NOT EXISTS STOCK_CATEGORY_DATA " +
            "(Common_Id INTEGER," +
            " CATEGORY_CD INTEGER, STORE_CD INTEGER,STATE_CD INTEGER,STORE_TYPE_CD VARCHAR," +
    ...
    public static final String URLFORRETROFIT = "http://himalaya.parinaam.in/himalaya.asmx/";
    public static final String URL_Notice_Board = "http://himalaya.parinaam.in/notice/notice.html";

    public static final String METHOD_LOGIN = "UserLoginDetailGT";
...
///attendence data
    ...
    public static final String CREATE_TABLE_INSERT_ADDITIONAL_VISIBILITY_DATA = "CREATE TABLE IF NOT EXISTS "
            + TABLE_INSERT_ADDITIONAL_VISIBILITY_DATA
            + "("
            + "KEY_ID"
            + " INTEGER PRIMARY KEY AUTOINCREMENT ,"
            + "CATEGORY_CD"
    ...
    public static final String TABLE_FEEDBACK_DATA = "FEEDBACK_DATA";

    public static final String CREATE_TABLE_FEEDBACK_DATA = "CREATE TABLE IF NOT EXISTS "
            + TABLE_FEEDBACK_DATA
            + "("
            + "KEY_ID"
            + " INTEGER PRIMARY KEY AUTOINCREMENT ,"
