...
import com.cpm.himalayaGT.MainMenuActivity;
...
public class UploadDataActivity extends Activity {
    ...
    private ArrayList<WindowListGetterSetter> window1 = new ArrayList<>();
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                for (int i = 0; i < coverageBeanlist.size(); i++) {
                    ...
                    if (!journeyPlanGetterSetter.getUploadStatus().get(0).equalsIgnoreCase(CommonString1.KEY_U) &&
                            !journeyPlanGetterSetter.getUploadStatus().get(0).equalsIgnoreCase(CommonString1.KEY_D)) {
                ...
                if (list.size() > 0) {
                    for (int i1 = 0; i1 < list.size(); i1++) {
                        ...
                        if (list.get(i1).contains("_NONWORKING_")) {
                            File originalFile = new File(Path + list.get(i1));
                            //Retrofit
                            result = RetrofitClass.UploadImageByRetrofit(UploadDataActivity.this, originalFile.getName(), "GTStoreImages");
                            if (!result.toString().equalsIgnoreCase(CommonString1.KEY_SUCCESS)) {
                                return result.toString();
                            }
                            data.value = 85;
                        ...
                        if (list.get(i1).contains("_POASMIMG_")) {
                            File originalFile = new File(Path + list.get(i1));
                            result = RetrofitClass.UploadImageByRetrofit(UploadDataActivity.this, originalFile.getName(), "GTPosmImages");
                            if (!result.toString().equalsIgnoreCase(CommonString1.KEY_SUCCESS)) {
                                return result.toString();
                            }
                            data.value = 90;
                        ...
                        if (list.get(i1).contains("_WINDOWIMG_")) {
                            File originalFile = new File(Path + list.get(i1));
                            result = RetrofitClass.UploadImageByRetrofit(UploadDataActivity.this, originalFile.getName(), "GTWindowImages");
                            if (!result.toString().equalsIgnoreCase(CommonString1.KEY_SUCCESS)) {
                                return result.toString();
                            }
                            data.value = 93;
                        ...
                        if (list.get(i1).contains("_CATEGORYIMG_")) {
                            File originalFile = new File(Path + list.get(i1));
                            //Retrofit
                            result = RetrofitClass.UploadImageByRetrofit(UploadDataActivity.this, originalFile.getName(), "GTStockImages");
                            if (!result.toString().equalsIgnoreCase(CommonString1.KEY_SUCCESS)) {
                                return result.toString();
                            }
                            data.value = 95;
                        ...
                        if (list.get(i1).contains("front")) {
                            File originalFile = new File(Path + list.get(i1));
                            //Retrofit
                            result = RetrofitClass.UploadImageByRetrofit(UploadDataActivity.this, originalFile.getName(), "GTGeoTagImages");
                            if (!result.toString().equalsIgnoreCase(CommonString1.KEY_SUCCESS)) {
                                return result.toString();
                            }
                            data.value = 95;
