...
public class XMLHandlers {
    ...
    public static AssetMappingGetterSetter AssetMappingXML(XmlPullParser xpp,
                                                           int eventType) {
        AssetMappingGetterSetter assetmaster = new AssetMappingGetterSetter();
        ...
        try {
            while (xpp.getEventType() != XmlPullParser.END_DOCUMENT) {
                if (xpp.getEventType() == XmlPullParser.START_TAG) {
                    ...
                    if (xpp.getName().equals("META_DATA")) {
                        assetmaster.setTableassetmapping(xpp.nextText());
                    }
                    if (xpp.getName().equals("STORE_CD")) {
                        assetmaster.setStore_cd(xpp.nextText());
                    }
                    ...
                    if (xpp.getName().equals("IMAGE_URL")) {
                        assetmaster.setPlanogram(xpp.nextText());
                    }
                    if (xpp.getName().equals("CATEGORY_CD")) {
                        assetmaster.setCategorycd_mapping(xpp.nextText());
                    }
    ...
    public static AssetMasterNewGetterSetter AssetMasterNewXML(XmlPullParser xpp,
                                                               int eventType) {
        AssetMasterNewGetterSetter assetmaster = new AssetMasterNewGetterSetter();
        ...
        try {
            while (xpp.getEventType() != XmlPullParser.END_DOCUMENT) {
                if (xpp.getEventType() == XmlPullParser.START_TAG) {
                    ...
                    if (xpp.getName().equals("META_DATA")) {
                        assetmaster.setAssetMasternewTable(xpp.nextText());
                    }
                    if (xpp.getName().equals("ASSET_CD")) {
                        assetmaster.setAsset_cd(xpp.nextText());
                    }
    ...
    public static NonWorkingReasonGetterSetter nonWorkinReasonXML(XmlPullParser xpp, int eventType) {
