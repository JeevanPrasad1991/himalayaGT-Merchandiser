...
public class AssetActivity extends AppCompatActivity implements OnClickListener{
	...
	public class ExpandableListAdapter extends BaseExpandableListAdapter {
		...
		public View getChildView(final int groupPosition, final int childPosition,
			...
			holder.tbpresent.setOnClickListener(new OnClickListener() {
			...
			holder.btn_checklist.setOnClickListener(new OnClickListener(){
			...
			holder.btn_cam.setOnClickListener(new OnClickListener() {
				@Override
				public void onClick(View v) {
