...
public class TableBean {
	...
	public static String getAssetmasterNewtable() {
		return assetmasterNewtable;
	}

	public static void setAssetmasterNewtable(String assetmasterNewtable) {
		TableBean.assetmasterNewtable = assetmasterNewtable;
	}

	public static String assetmasterNewtable;

	public static String getAssetmappindtable() {
		return assetmappindtable;
	}

	public static void setAssetmappindtable(String assetmappindtable) {
		TableBean.assetmappindtable = assetmappindtable;
	}

	public static String assetmappindtable;
